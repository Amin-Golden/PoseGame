...
# time.sleep(5)
# for i in range(0,20) :
#     ahk.mouse_drag(100, 300, relative=False) # Holds down primary button and moves the mouse
#     time.sleep(0.2)
#     ahk.mouse_drag(800, 300, relative=False) # Holds down primary button and moves the mouse
#     time.sleep(0.2)
